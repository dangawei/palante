                    ...
                    <Row>
                       <Col :xs="24" :sm="24" :md="8" :lg="8">
                          <FormItem label="车辆型号:" prop="value" >
                            <car-model @carmodelselect="carmodelselect01" :carModelName="formValidate.carModelName" v-if="show"></car-model>
                          </FormItem>
                        </Col>
                     <Col :xs="24" :sm="24" :md="8" :lg="8">
                          <FormItem label="sku:">
                              <sku-model @skucomponentemit="skucomponentemit" :modelId="formValidate.modelId" :skuId="formValidate.carSkuId" v-if="skushow"></sku-model>
                          </FormItem>
                        </Col>
                       <Col :xs="24" :sm="24" :md="8" :lg="8">
                          <div class="">
...
<script>
  ...
  export default {
    ...
    mounted() {
      this.formValidate.modelId = this.detailData.carModelId
      this.formValidate.carSkuId = this.detailData.carSkuId
      this.formValidate.carModelName = this.detailData.carModelName
      if(this.detailData.carSkuId){
        this.formValidate.skuId = parseInt(this.detailData.carSkuId)
      }
      this.formValidate.quantity = this.detailData.quantity
      this.show = this.addshow
      this.skushow = this.addshow
      this.list()
    },
    methods: {
      save () {
