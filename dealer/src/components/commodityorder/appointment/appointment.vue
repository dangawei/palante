<template>
  ...
  <appointment-driving @appointment="appointmentemit" :addshow="addshow" :id="itemnew.id" :time="itemnew.time" v-if="addshow"></appointment-driving>
  </div>
</template>
<script>
  import Pages from '../../pub/page.vue'
  import appointmentDriving from "./add.vue"
  export default {
    components: {
        Paging:Pages,
        appointmentDriving,
