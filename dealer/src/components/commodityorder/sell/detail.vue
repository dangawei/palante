    ...
    <div class="pageHeader">
      <div class="pageBread">
        <Breadcrumb>
          ...
          <BreadcrumbItem to="/sell">售卖订单列表</BreadcrumbItem>
        </Breadcrumb>
      </div>
      <div class="page-detail">
        <div class="page-detail-hd">
          <h2>售卖订单{{formItem.rentOrderNo}}详情</h2>
        </div>
      </div>
    </div>
               ...
               <Col :xs="24" :sm="24" :md="8" :lg="8">
                 <div class="">
                      <FormItem label="车辆图片：" label-position="left" prop="skuName">
                          <p><a :href="formItem.pic" target="_blank"><img :src="formItem.pic" width="100" height="100" /></a></p>
                      </FormItem>
                 </div>
              </Col>
              <Col :xs="24" :sm="24" :md="8" :lg="8">
