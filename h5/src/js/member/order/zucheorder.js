   ...
   var order = {
      ...
      orderhtml:function () {
          ...
          orderdata.forEach(function (item) {
            ...
            '</div>'+
            '<div class="orderitemprice fl">￥'+item.unitPrice+'元</div><div class="orderitemnum fl">'+item.quantity+'</div><div class="orderitemoption fl"><a href="#"></a></div></div></td><td class="orderleft"><div class="orderTotal fl"><b>￥'+item.totalPrice+'</b></div></td><td class="orderleft">'+
