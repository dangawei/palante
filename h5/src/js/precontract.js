    ...
    bannerhtml:function () {
       var _this = this;
        ...
        cardlist.forEach(function (a) {
          str += '<li data-id='+a.id+'><div class="cardmodel"><p class="cardimg" style="background:url('+a.modelPic+') center no-repeat;background-size: 240px auto;"></p><p>'+a.modelName+'</p></div></li>'
        })
