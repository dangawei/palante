define(function(require,exports,module){
	...
	var lnglats = [
        [120.152509, 30.284932],
        [120.152909, 30.285832],
        [120.152109, 30.284432],
        [120.152809, 30.285432],
    ];
    var remoteDataArr=[];
    var cityDatas=[];
	var dealersearch={
							...
							if(remoteData.codeId==1){
							    ...
							    for (var i = 0; i < _this.remoteDataArr.length; i++) {
							    	...
							    	_this.lnglats.push(ll)
							   		var content='<div class="c-item"><p class="title">'+remoteData.resData.list[i].name+'</p><p class="distance">1km</p><p class="address">'+remoteData.resData.list[i].address+'</p></div>';
