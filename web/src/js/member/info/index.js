      ...
      var info = {
          ...
          userstatus:function () {
              ...
              var str = ""
               ...
               $el.find('#J_userSave').off('click').click('#J_userSave', function (e) {
                 _this.post()
               })
          },
          upfile:function () {
          ...
          post:function () {
            var _this = this;
            if($("#J-agx").val()==""){
               common.showTip("年龄没有填写")
               return
            }
            if($("#J-adress").val()==""){
               common.showTip("具体地址没有填写")
               return
            }
            if($("#J-iphone").val()==""){
               common.showTip("手机号码没有填写")
               return
            }
            if(userdata.provinceCode==""){
               common.showTip("省份没有选择")
               return
            }
            if(userdata.cityCode==""){
               common.showTip("市区没有选择")
               return
            }
            if(userdata.areaCode==""){
               common.showTip("市县没有选择")
               return
            }
            if($("#J-sex").val()==""){
               common.showTip("性别没有选择")
               return
            }
            if(userdata.birthday==""){
               common.showTip("生日时间没有选择")
               return
            }
            common.loginAjax({
