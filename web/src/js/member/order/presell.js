   ...
   var order = {
      ...
      orderhtml:function () {
          ...
          orderdata.forEach(function (item) {
            ...
            if(item.orderType!==3){
              orderitemprice = '<div class="orderitemprice fl">￥'+item.unitPrice+'元</div>'
            }else {
              orderitemprice = '<div class="orderitemprice fl">￥'+item.tradeAmount/item.quantity+'元</div>'
            }
            if(item.status == 3){
            ...
            '</div>'+orderitemprice+
            '<div class="orderitemnum fl">'+item.quantity+'</div><div class="orderitemoption fl"><a href="#"></a></div></div></td><td class="orderleft"><div class="orderTotal fl"><b>￥'+item.tradeAmount+'</b></div></td><td class="orderleft">'+
