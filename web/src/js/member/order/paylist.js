     ...
     listhtml:function () {
        ...
        var strhtml = ''
            strhtml = '<div class="item">'+
                     '<div class="item-img"><img src="'+orderdata.carSkuPicUrl+'" width="100" height="100"alt=""></div>'+
       ...
       var str = '<div class="order-status">'+
        '<div class="order-status-hd"><span class="f20 colororg">'+status+'</span><span class="f20 colororg"><i>订单总价：</i>￥'+orderdata.tradeAmount+'</span></div>'+
