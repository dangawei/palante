		...
		init:function(){
		    ...
		    _this.GetItemType();
				if(common.getUrlParam("itemType")==1){
					$("#rent_car").addClass("none")
					$("#yugou_car").addClass("none")
				}else if(common.getUrlParam("itemType")==2){
					$("#buy_car").addClass("none")
					$("#yugou_car").addClass("none")
				}	else if(common.getUrlParam("itemType")==3){
					$("#rent_car").addClass("none")
					$("#buy_car").addClass("none")
				}
		},
				...
				success:function(remoteData){
					if(remoteData.codeId==1){
						...
						if (urlDatas.brandId) {
							...
							for (var i = 0; i < _this.brandDatas.length; i++) {
