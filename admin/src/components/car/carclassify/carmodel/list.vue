  ...
  <div class="pageHeader">
      <div class="pageBread">
          <Breadcrumb>
              ...
              <BreadcrumbItem>车辆属性</BreadcrumbItem>
          </Breadcrumb>
      </div>
...
export default {
    ...
    methods: {
      ...
      list () {
        ...
        this.$api.get('/car_model_property/list',data,reset => {
            if (reset.codeId === 1) {
      ...
      remove (params) {
          ...
          this.$Modal.confirm({
              ...
              onOk: () => {
                let _this = this;
                let url="/car_model_property/delete?token=" + this.$webapi.get('token') + "&id=" + params.id;
