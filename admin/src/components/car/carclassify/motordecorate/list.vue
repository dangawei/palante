  ...
  <div class="pageHeader">
      <div class="pageBread">
          <Breadcrumb>
              ...
              <BreadcrumbItem>电机布置形式</BreadcrumbItem>
          </Breadcrumb>
      </div>
...
export default {
    ...
    methods: {
      ...
      list () {
        ...
        this.$api.get('/motor_decorate_form/list',data,reset => {
            if (reset.codeId === 1) {
      ...
      remove (params) {
          ...
          this.$Modal.confirm({
              ...
              onOk: () => {
                let _this = this;
                let url="/motor_decorate_form/delete?token=" + this.$webapi.get('token') + "&id=" + params.id;
