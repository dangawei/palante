  ...
  <div class="pageHeader">
      <div class="pageBread">
          <Breadcrumb>
              ...
              <BreadcrumbItem>车辆动力方式</BreadcrumbItem>
          </Breadcrumb>
      </div>
...
export default {
    ...
    methods: {
      ...
      list () {
        ...
        this.$api.get('/car_dynamic_way/list',data,reset => {
            if (reset.codeId === 1) {
      ...
      remove (params) {
          ...
          this.$Modal.confirm({
              ...
              onOk: () => {
                let _this = this;
                let url="/car_dynamic_way/delete?token=" + this.$webapi.get('token') + "&id=" + params.id;
