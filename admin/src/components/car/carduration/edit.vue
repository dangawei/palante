    ...
    <Modal v-model="show" width="360" @on-cancel="cancel" :mask-closable="false">
       ...
       <div style="text-align:center">
         <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
              ...
              <FormItem label="值:" prop="duration" >
                 <Input v-model="formValidate.duration" ></Input>
              </FormItem>
              <FormItem>
...
export default {
    ...
    mounted() {
      ...
      this.formValidate.duration = this.editduration
    ...
    methods: {
      ...
      post() {
          ...
          this.$api.post("/user_rental_duration/update", data, reset => {
            if (reset.codeId === 1) {
