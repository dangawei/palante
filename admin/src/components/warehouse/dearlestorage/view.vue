                 ...
                 <Col :xs="24" :sm="24" :md="8" :lg="6">
                   ...
                   <!-- <Col :xs="24" :sm="24" :md="8" :lg="6">
                      <FormItem label="车辆型号" prop="value" >
                        <car-model @carmodelselect="carmodelselect01" :modelType="1" :modelID="formCustom.carModelId"></car-model>
                      </FormItem>
                    </Col>
                 <Col :xs="24" :sm="24" :md="8" :lg="6">
                      <FormItem label="sku">
                         <sku-model @skucomponentemit="skucomponentemit" :modelId="formCustom.carModelId"></sku-model>
                      </FormItem>
                  </Col> -->
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.formCustom.carModelId = this.$route.params.modelId
      this.formCustom.dealerId = this.$route.params.dealerId
      this.list()
    },
    methods: {
      exportfile () {
      ...
      list () {
        ...
        var _this =  this
        this.$api.get('/car/dealer_car_page',listdata,reset => {
          if (reset.codeId === 1) {
