        ...
        <div class="pagelist">
          ...
          <div class="pagelist-bd">
            ...
            <Row>
              ...
              <Col :xs="24" :sm="24" :md="8" :lg="8">
                <FormItem label="租用期限：" prop="userName">
                  <p>{{formItem.duration}}个月</p>
                </FormItem>
              </Col>
            </Row>
            <Row>
              <Col :xs="24" :sm="24" :md="8" :lg="8">
                <FormItem label="取车时间：" prop="userName">
                  <p>{{formItem.pickUpDate/1000 | ordertime}}</p>
                </FormItem>
              </Col>
              <Col :xs="24" :sm="24" :md="8" :lg="8">
                <FormItem label="还车时间：">
        ...
        <div class="pagelist">
          ...
          <div class="pagelist-bd">
            ...
            <Row>
               <Col :xs="24" :sm="24" :md="8" :lg="8">
                 <div class="">
                      <FormItem label="单车保证金：" label-position="left" prop="skuName">
