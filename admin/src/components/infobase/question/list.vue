        ...
        <div class="page-component-view">
            <div class="page-component-bd">
                ...
                <!-- <Modal
                    ...
                    title="添加"
                    >
                    <question-component-add></question-component-add>
                    <div slot="footer" style="display:none">
                    </div>
                </Modal>
                <question-component-edit @editquestioncomponentdata="editquestioncomponentdata" :editquestionshow="editquestionshow" :editquestiondata="editquestiondata" v-if="editquestionshow"></question-component-edit>
 -->
        ...
        methods: {
            ...
            handleSubmit (name) {
                this.$refs[name].validate((valid) => {
                    console.log(this.formCustom.id);
