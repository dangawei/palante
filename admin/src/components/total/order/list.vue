            ...
            <Col :xs="24" :sm="24" :md="12" :lg="12">
              <div class="total_card">
                <Card>
                    <div class="zd_cardbody">
                      <div class="card_hd">
                         <div class="">订单汇总统计</div>
                         <div class="">
                           <Tooltip content="订单汇总统计" placement="top">
                              <Icon type="ios-information-outline" size="20"></Icon>
                          </Tooltip>
                         </div>
                      </div>
                      <div class="card_bd">
                        <Tabs value="1" @on-click="tablist" >
                            <TabPane label="订单汇总" name="1">
                              <div class="" style="margin:0 10px">
                                  <Table border :columns="columnsdata" :data="data.orderBuyerTotalAdminList"></Table>
                              </div>
                            </TabPane>
                        </Tabs>
                      </div>
  ...
  export default {
    ...
    mounted() {
      if(this.$webapi.get("accountType")==2){
        this.$router.push({path:"/dearleorder/totallist"})
      }
      this.list()
    },
    methods: {
      ...
      newtablist (e){
        var resetdata = []
        if(this.data.orderBuyerTypeSubcompany.length>0){
          this.data.orderBuyerTypeSubcompany.forEach(function (a) {
            if(a.orderType == e){
               resetdata.push(a)
            }
          })
