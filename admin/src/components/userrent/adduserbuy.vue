    ...
    <div class="pageHeader">
      <div class="pageBread">
        <Breadcrumb>
          ...
          <BreadcrumbItem :to="{path:'/userbuylist/'+this.$route.params.modelId+'/'+this.$route.params.id,query:{sku:skutitle}}">用户采购价格列表</BreadcrumbItem>
          </Breadcrumb>
    ...
    methods:{
      ...
      handleSubmit(){
        ...
        if (this.areaPriceListDatas[0].price!=0 && this.areaPriceListDatas[0].addressData.length!=0) {
          console.log(this.areaPriceListDatas);
