<template>
          ...
          <Row style="text-align:center;">
            <Col :xs="24" :sm="24" :md="24" :lg="24">
              <div class="">
                ...
                <Button type="primary"  @click="pay()" :disabled="status!=1">审核支付</Button>
               </div>
            </Col>
          </Row>
        </div>
  ...
  <auit-component  :reasonShow="reasonShow" @reasonEmitCompont="reasonEmitCompont"></auit-component>
  </div>
</template>

<script>
  // import SmsModel from "../../pub/smsmodel"
 import auitComponent from "../../pub/auitcomponent"
export default {
  name: 'index',
  components: {
    // SmsModel
